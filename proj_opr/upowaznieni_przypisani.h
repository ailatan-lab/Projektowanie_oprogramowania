...
namespace projopr {
	...
	/// <summary>
	/// Summary for upowaznieni_przypisani
	/// </summary>
	public ref class upowaznieni_przypisani : public System::Windows::Forms::Form
	{
	private:
		Form^ previousForm;
	...
	public:
		...
		upowaznieni_przypisani(System::String^ initialValue)
		{
			InitializeComponent();
			Login = initialValue;
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->powrot->Click += gcnew System::EventHandler(this, &upowaznieni_przypisani::powrot_Click);
			// 
			// zobacz_pliki
			// 
			...
			this->zobacz_pliki->Click += gcnew System::EventHandler(this, &upowaznieni_przypisani::zobacz_pliki_Click);
			// 
			// listView1
			// 
			...
			this->Name = L"upowaznieni_przypisani";
			this->Text = L"upowaznieni_przypisani";
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &upowaznieni_przypisani::upowaznieni_przypisani_FormClosing);
			this->Load += gcnew System::EventHandler(this, &upowaznieni_przypisani::upowaznieni_przypisani_Load);
			this->ResumeLayout(false);
			this->PerformLayout();

		}
#pragma endregion
	private: System::Void upowaznieni_przypisani_Load(System::Object^ sender, System::EventArgs^ e) {
		...
		if (mysql_real_connect(mysql, "127.0.0.1", "root", "", "mydb", 4306, NULL, 0))
		{
			...
			std::string zapytanie = "select pacjenci.imie, pacjenci.nazwisko, pacjenci.adres, pacjenci.numer_pesel from pacjenci join upowaznienia on upowaznienia.pesel_pacjent = pacjenci.numer_pesel join upowaznieni on upowaznienia.pesel_upowazniony = upowaznieni.idupowaznieni_pesel where upowaznieni.login like '"+Login_zwykly+"' and upowaznienia.czy_upowaznione = true";
...
private: System::Void upowaznieni_przypisani_FormClosing(System::Object^ sender, System::Windows::Forms::FormClosingEventArgs^ e) {
	if (zamykanie = true)
	{
		previousForm->Show();
	}
